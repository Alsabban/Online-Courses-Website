        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center text-white mx-auto">
                    <h2> Adminstrators Log in</h2>
                    <p class="w-lg-50">Please enter your admin username and password.</p>
                </div>
            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" method="post" action="adminLogged.php">
                                <div class="mb-3"><input class="form-control" type="text" name="username" placeholder="Admin Username"></div>
