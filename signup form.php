        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center text-white mx-auto">
                    <h2>Sign Up</h2>
                    <p class="w-lg-50">Please enter your details.</p>
                </div>
            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            <form class="text-center" action="student-details.php">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="password" class="form-control" type="password" name="password" placeholder="Password"></div>
                                <div class="mb-3">
                                    <button id="signupBtn" class="btn btn-primary d-block w-100" type="submit">Sign Up</button></div>
                                <p class="text-muted">Already Have an account?&nbsp;<a href="login.php">Sign In now!</a></p>
                            </form>
                        </div>
                    </div>
                </div>
