<!DOCTYPE html>
<html lang="en" style="color: var(--bs-white);">
    ...
    <div class="row product-list" data-aos="fade-up" data-aos-duration="550" data-aos-delay="550">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2><a id="course-name-reg" href="#">BIO1: Biology</a></h2>
                    </div>
                </div>
                <div class="product-rating"></div>
                <div class="row">
                    <div class="col-12">
                        <p class="text-start product-description">Course Description: This course includes a study of living organisms and vital processes. Themes that will be covered in this course include scientific skills, ecology, biochemistry, cellular processes, genetics, evolution, classification of organisms, as well as plant and human body systems.<br></p>
                        <div class="row">
                            <div class="col-6"></div>
                            <div class="col-6">
                                <p class="fs-6 text-start product-price">Instructed by the following Instructor(s):<br></p><a href="instructor-info.html#profharrislew">Prof. Harris Lew.</a>
                            </div>
                        </div>
                    </div>
                </div>
