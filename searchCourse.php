...
<body style="height: 583px;background: url(&quot;assets/img/hero-bg.jpg&quot;) center / cover;">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <input class="form-control-lg" type="search" name="searchBar" style="color:white; text-align: left;height: 57px;width: 461.4px;background: rgba(255,255,255,0);color: var(--bs-gray-200);" placeholder="Search by Course ID">
            <button id="addinstructorBtn" class="btn btn-primary d-block w-100" name="searchBtn" type="submit">Search</button>
            </form>
        </div>
        <div class="col">
