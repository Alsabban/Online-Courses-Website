    ...
    <div class="row product-list" data-aos="fade-up" data-aos-duration="550" data-aos-delay="550">
        ...
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                <div class="row">
                    <div class="col-md-12"><a class="product-image" href="#"><img src="assets/img/Physics2.jpg"></a></div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h2><a id="course-name-reg" href="#">CHEM1: Chemistry</a></h2>
                    </div>
                </div>
                <div class="product-rating"></div>
                <div class="row">
                    <div class="col-12">
                        <p class="text-start product-description">Course Description: This course covers the qualitative and quantitative aspects of scientific measurement, the nature of matter, gases, liquids and solids, energy, atomic theory, properties of elements, chemical bonding, molecular structure and properties, stoichiometry, thermochemistry, and solutions.<br></p>
                        <div class="row">
                            <div class="col-6"></div>
                            <div class="col-6">
                                <p class="fs-6 text-start product-price">Instructed by the following Instructor(s):<br></p><a href="instructor-info.php#profharrislew">Prof. Harris Lew.</a>
                            </div>
                        </div>
                    </div>
                </div>
