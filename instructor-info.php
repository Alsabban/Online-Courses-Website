...
<body style="height: 583px;background: url(&quot;assets/img/hero-bg.jpg&quot;) center / cover;">
    ...
    <div class="row product-list" data-aos="fade-up" data-aos-duration="550" data-aos-delay="550">
        <div class="col-sm-6 col-md-4 product-item"></div>
        <div class="col-sm-6 col-md-4 product-item">
            <div class="product-container">
                ...
                <div class="row">
                    <div class="col-8" id="harrislew">
                        <h2 id="profharrislew"><a href="#">Prof. Harris Lew</a></h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <p class="product-description">Instructed Courses:<br>- Engineering Chemistry<br>- Thermodynamics<br>- Phyiscs 1</p>
                        <div class="row">
                            <div class="col-12 text-center">
                                <p>Top Review:<br><br>Prof. Harris will make you love Physics.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <main>
        <footer class="text-center bg-light">
            <div class="container text-muted py-4 py-lg-5">
                ...
                <ul class="list-inline">
                    <li class="list-inline-item me-4"><a class="link-secondary" href="" data-bs-target="" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
