        ...
        <div id="studentDetailsDiv" style='height:500px;'>
            ...
            <?php
               ...
               // echo "Successfully connected to the database.<br>"; 
                ...
                $stmt = "INSERT INTO `student` (`name`, `mobile`, `email`, `password`) VALUES ('$name', '$phone', '$email', '$password')";
                $result = mysqli_query($conn, $stmt);
                if($result==FALSE) 
                echo "Error. $name department was not added";
                else
                echo "<p style='color:white;'> Name: $name</p> <p style='color:white;'>Phone: $phone</p> <p style='color:white;'>Email: $email</p> <p style='color:white;'>Password: $password</p>"
